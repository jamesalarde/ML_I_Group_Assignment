...
def prediction_interface():
    ...
    with col2:
      ...
      st.write('')
    with col2:
      SkinThickness = st.number_input('Skin Thickness in mm', min_value = 5, max_value = 100, value = 5, step = 1)
      st.write('')
    with col2:
      Insulin = st.number_input('Insulin level in mu U/ml', min_value = 2, max_value = 300, value = 2, step = 1)
      st.write('')
    with col2:
